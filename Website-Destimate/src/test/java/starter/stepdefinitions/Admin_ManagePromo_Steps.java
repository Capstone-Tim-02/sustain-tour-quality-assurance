...
public class Admin_ManagePromo_Steps {
    ...
    @And("I search the Promo Family Package")
    ...
    public void validateSuccessToDeletePromoAndDisplayMessage(String arg0) {
    }
    ...
    @And("I search the name of promo NEWYEAR2024")
    ...
    @And("I search name promo November")
    ...
    public void validateFailedToSearchPromoAndDisplayMessage(String arg0) {
    }
    ...
    public void validateFailedToGettingAnswerAndDisplayErrorMessage(String arg0) {
    }
    ...
    @Then("Validate success to clear the history of previous Q&A interactions")
    public void validateSuccessToClearTheHistoryOfPreviousQAInteractions() {
    }
    ...
    public void validateSuccessToDisplayDataPromoBetweenToData(int arg0, int arg1) {
    }
    ...
    public void validateSuccessToDisplayADataPromoBetweenToData(int arg0, int arg1) {
    }
