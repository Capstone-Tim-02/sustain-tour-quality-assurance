...
public class Admin_ManageUserData extends PageObject {
    ...
    @Step
    public void clickSimpanButton(){$(simpanButton()).click();
    }

    @Step
    public boolean validateSuccessEditAccountUserWithValidUsername(String successMessageEditUsername){
        return ($(messageSuccessEditAccountUser()).getText().equalsIgnoreCase(successMessageEditUsername));
    }
    ...
    @Step
    public boolean validateFailedEditAccountBecauseInvalidUsername(String failedMessageInUsername){
        return $(messageFailedEditAccountUserInUsernameField()).getText().equalsIgnoreCase(failedMessageInUsername);
    }
    ...
    @Step
    public boolean validateFailedEditAccountBecauseEmptyUsername(String failedMessageBecauseEmptyUsername){
        return $(messageFailedEditAccountUserInUsernameField()).getText().equalsIgnoreCase(failedMessageBecauseEmptyUsername);
    }
    ...
    @Step
    public boolean validateSuccessEditAccountUserWithValidName(String successMessageEditName){
        return $(messageSuccessEditAccountUser()).getText().equalsIgnoreCase(successMessageEditName);
    }
    ...
    @Step
    public boolean validateFailedEditAccountBecauseInvalidName(String failedMessageInName){
        return $(messageFailedEditAccountUserInNameField()).getText().equalsIgnoreCase(failedMessageInName);
    }
    ...
    @Step
    public boolean validateFailedEditAccountBecauseEmptyName(String failedMessageBecauseEmptyName){
        return $(messageFailedEditAccountUserInNameField()).getText().equalsIgnoreCase(failedMessageBecauseEmptyName);
    }
    ...
    @Step
    public boolean validateSuccessEditAccountUserWithValidEmail(String successMessageEditEmail){
        return $(messageSuccessEditAccountUser()).getText().equalsIgnoreCase(successMessageEditEmail);
    }
    ...
    @Step
    public boolean validateFailedEditAccountBecauseInvalidEmail(String failedMessageInEmail){
        return $(messageFailedEditAccountUserInEmailField()).getText().equalsIgnoreCase(failedMessageInEmail);
    }
    ...
    @Step
    public boolean validateFailedEditAccountBecauseEmptyEmail(String failedMessageBecauseEmptyEmail){
        return $(messageFailedEditAccountUserInEmailField()).getText().equalsIgnoreCase(failedMessageBecauseEmptyEmail);
    }
    ...
    @Step
    public boolean validateSuccessEditAccountUserWithValidPhoneNumber(String successMessageEditPhoneNumber){
        return $(messageSuccessEditAccountUser()).getText().equalsIgnoreCase(successMessageEditPhoneNumber);
    }
    ...
    @Step
    public boolean validateFailedEditAccountBecauseInvalidPhoneNumberWithAbjad(String failedMessageInPhoneNumberWithAbjad){
        return $(messageFailedEditAccountUserInPhoneNumberField()).getText().equalsIgnoreCase(failedMessageInPhoneNumberWithAbjad);
    }
    ...
    @Step
    public boolean validateFailedEditAccountBecauseInvalidPhoneNumberLessThan10Digit(String failedMessageInPhoneNumberLessThan10Digit){
        return $(messageFailedEditAccountUserInPhoneNumberField()).getText().equalsIgnoreCase(failedMessageInPhoneNumberLessThan10Digit);
    }
    ...
    @Step
    public boolean validateFailedEditAccountBecauseEmptyPhoneNumber(String failedMessageBecauseEmptyPhoneNumber){
        return $(messageFailedEditAccountUserInPhoneNumberField()).getText().equalsIgnoreCase(failedMessageBecauseEmptyPhoneNumber);
    }
    ...
    @Step
    public boolean validateSuccessDeleteAccountUser(String successMessageDeleteAccount){
        return $(messageSuccessDeleteAccountUser()).getText().equalsIgnoreCase(successMessageDeleteAccount);
    }
    ...
    @Step
    public boolean validateFailedToGetResultOfSearchingUserAccount(String notFoundUser){
        return $(messageDataNotAvailable()).getText().equalsIgnoreCase(notFoundUser);
    }
