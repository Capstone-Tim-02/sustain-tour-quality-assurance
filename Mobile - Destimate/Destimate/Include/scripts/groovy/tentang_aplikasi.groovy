...
class tentang_aplikasi {
	...
	def clickTentangAppButton() {
		Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)
		
		Mobile.tap(findTestObject('about/aboutApp'), 0)
	}

	@Then("i will redirect to Tentang Aplikasi page")
	def redirectToTentangAppPage() {
		Mobile.verifyElementExist(findTestObject('about/aboutAppPage'), 0)

		Mobile.tap(findTestObject('about/backButton'), 0)
	...
	def iClickBackFromTentangAppPage() {
		Mobile.tap(findTestObject('about/backButton'), 0)
	}

	@Then("i will redirect to Profile page")
	def iRedirectToProfile() {
